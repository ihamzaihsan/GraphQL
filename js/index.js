...
const usernameEl = document.querySelector('.form-container .form-row input[name="username"]');
...
const passwordTl = createEmailTl();
...
usernameEl.addEventListener('input', () => {
    usernameValid = usernameEl.value.length > 3;
    if (usernameValid) {
